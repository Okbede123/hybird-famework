...
public class Level_20_Pattern_Object_DemoHeadLess extends BaseTest {
    WebDriver driver;
...
//        userLoginPageObject.clickToLogin();
    ...
    public void TC_03_LoginWithIncorrectEmail() {
        ...
        userLoginPageObject = userHomePageObject.getFooterContainPage(driver).getMyAccountNotLogged();
        userLoginPageObject.enterToTextBoxById(driver,"auto_test" + getrandomNumber() + "@live.com","email");
...
//        loginPageObject = new LoginPageObject(driver);
        userLoginPageObject = userHomePageObject.getFooterContainPage(driver).getMyAccountNotLogged();
        userLoginPageObject.enterToTextBoxById(driver,"selenium_11_01@gmail.com","email");
        userLoginPageObject.enterToTextBoxById(driver,"111111","pass");
