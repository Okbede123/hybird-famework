...
public class Level_24_JSON_DATA extends BaseTest {
    WebDriver driver;
    ...
    String emailAddress = accountData.getEmailAddress() + getrandomNumber() + accountData.getWebEmailServer();
...
//        assertEqual(userLoginPageObject.getPassWordAdressEmptyMessageError(),"This is a required field.");
    ...
    public void TC_02_LoginWithInvalidEmail() {
        ...
        userLoginPageObject.enterToTextBoxById(driver,accountData.getPassword(),"pass");
//        userLoginPageObject.clickToLogin();
        userLoginPageObject.clickToButtonByTitle(driver,"Login");
...
//        userLoginPageObject.clickToLogin();
    ...
    public void TC_05_Register_Success(){
       ...
       userLoginPageObject.clickToButtonByTitle(driver,"Create an Account");
        ...
        userRegisterPageObject.enterToTextBoxById(driver,accountData.getFirstName(),"firstname");
        userRegisterPageObject.enterToTextBoxById(driver,accountData.getLastName(),"lastname");
        userRegisterPageObject.enterToTextBoxById(driver, accountData.getEmailAddress(),"email_address");
        userRegisterPageObject.enterToTextBoxById(driver,accountData.getPassword(),"password");
        userRegisterPageObject.enterToTextBoxById(driver,accountData.getPassword(),"confirmation");
