...
import src2.testdataa.techpanda.account.Account;

public class Level_23_Into_Class_InternalFile extends BaseTest {
    WebDriver driver;


    String emailAddress = Account.Login.PRE_EMAIL_ADDRESS + getrandomNumber() + Account.Login.WEB_EMAIL_ADDRESS;


    src2.actions.pageObjects.UserHomePageObject userHomePageObject;
...
//        assertEqual(userLoginPageObject.getPassWordAdressEmptyMessageError(),"This is a required field.");
    ...
    public void TC_02_LoginWithInvalidEmail() {
        ...
        userLoginPageObject.enterToTextBoxById(driver,Account.Login.PASSWORD,"pass");
//        userLoginPageObject.clickToLogin();
        userLoginPageObject.clickToButtonByTitle(driver,"Login");
    ...
    public void TC_03_LoginWithIncorrectEmail() {
        ...
        userLoginPageObject = userHomePageObject.getFooterContainPage(driver).getMyAccountNotLogged();
        userLoginPageObject.enterToTextBoxById(driver, emailAddress,"email");
...
//        userLoginPageObject.clickToLogin();
    ...
    public void TC_05_Register_Success(){
       ...
       userLoginPageObject.clickToButtonByTitle(driver,"Create an Account");
        ...
        userRegisterPageObject.enterToTextBoxById(driver,Account.Login.FIRSTNAME,"firstname");
        userRegisterPageObject.enterToTextBoxById(driver,Account.Login.LASTNAME,"lastname");
        userRegisterPageObject.enterToTextBoxById(driver, emailAddress,"email_address");
        userRegisterPageObject.enterToTextBoxById(driver,Account.Login.PASSWORD,"password");
        userRegisterPageObject.enterToTextBoxById(driver,Account.Login.PASSWORD,"confirmation");
