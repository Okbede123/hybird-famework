...
public class LoginPageUI {
    ...
    public static final String PASSWORD_ADDRESS_TEXTBOX = "//input[@id = 'pass']";
    ...
    public static final String PASSWORD_ADDRESS_INVALID_ERROR_MESSAGE = "//div[@class = 'validation-advice']";
